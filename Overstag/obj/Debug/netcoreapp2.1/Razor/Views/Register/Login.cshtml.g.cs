#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "41fc74cf17a34863f1b2914d1cb2fab1af68fce5"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"41fc74cf17a34863f1b2914d1cb2fab1af68fce5", @"/Views/Register/Login.cshtml")]
...
#line hidden
            ...
            WriteLiteral("    ");
            EndContext();
            BeginContext(299, 5198, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6029d397c86346afb8378bce707e5b2d", async() => {
                BeginContext(305, 5185, true);
                WriteLiteral(@"
        <div class=""row"">
            <div class=""col s12 m6 offset-m3"">
                ...
                WriteLiteral(@"sword"">Wachtwoord</label>
                        ...
                        <div class=""card-action center-align"">
                            ...
                            <a class=""btn btn-large blue-light waves-effect"" id=""btnlogin"">Inloggen</a><br />
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id=""memailreset"" class=""modal"">
            ...
            <div class=""modal-footer"">
                ...
                <a href=""#!"" i");
                WriteLiteral(@"d=""sendmailreset"" class=""waves-effect waves-green btn-flat"">Verzenden</a>
            </div>
        </div>
        ...
        <div id=""tfa"" class=""modal"">
            <div class=""modal-content"">
                ...
                WriteLiteral(@"waves-effect red btn"" onclick=""Login.cancel2fa();"">Annuleren</a>
                    </div>
                </div>
            </div>
        </div>
       ...
       ");
            ...
            EndContext();
            BeginContext(5497, 81, true);
            WriteLiteral("\r\n<script>\r\n\r\n    let wrong2fa = 0;\r\n    var token = \"\";\r\n    let redirecturl = \'");
            EndContext();
            BeginContext(5579, 5, false);
#line 105 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml"
                  Write(Model);

#line default
#line hidden
            EndContext();
            BeginContext(5584, 7617, true);
            WriteLiteral(@"';
    ...
    Login = {
     ...
     ");
        ...
        redirect: function () {
            ...
            if (redirecturl != '') {
          ");
            WriteLiteral(@"      $(location).attr('href', redirecturl);
                return;
            }
        ...
        validate2fa: function() {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                ...
                var now = new Date();
                var timestring = now.getDate().toString().padStart(2, '0')+'-'+(now.getMonth() + 1).toString().padStart(2, '0')+'-'+now.getFullYear()+' '+now.getHours().toString().padS");
            WriteLiteral(@"tart(2, '0')+':'+now.getMinutes().toString().padStart(2, '0')+':'+now.getSeconds().toString().padStart(2, '0');
        ...
        restore2fa: function () {
            ...
            ");
            WriteLiteral(@"            M.toast({ html: 'Code onjuist', classes: 'red' });
