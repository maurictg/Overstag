#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "54026da77e64d6ea06da570c47c7d8954bda9e33"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"54026da77e64d6ea06da570c47c7d8954bda9e33", @"/Views/Register/Login.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "10342709609e4054a3454528f3093b72", async() => {
            ...
            $.post(""/Register/postLogin"", { Username: $('#Username').val(), Password: $('#Password').val() }, function (response) {
                if (response.status == 'success') {
                    ...
                    if (response.twofactor == 'yes') {
                        ...
                        $('#2facode').focus();
        ");
            WriteLiteral(@"                token = response.token;
                    }
                    else
                        Login.redirect();
                }
