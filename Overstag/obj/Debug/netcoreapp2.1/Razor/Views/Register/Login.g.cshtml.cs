#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "24f946274e3ccc9f9fdd820d7bb479eba74630c1"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"24f946274e3ccc9f9fdd820d7bb479eba74630c1", @"/Views/Register/Login.cshtml")]
...
#line hidden
            ...
            WriteLiteral("    ");
            EndContext();
            BeginContext(59, 5225, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c8b16a20499f4dea9c056509f316fff2", async() => {
                BeginContext(65, 5212, true);
                WriteLiteral(@"
        <div class=""row"">
            ...
            <div");
                ...
                <div class=""row"">
                    <div class=""center-align"">
                        ...
                        <div class=""row"">
                            <div class=""input-field col m4 s12 offset-s4"">
...
");
            ...
            EndContext();
            BeginContext(5284, 81, true);
            WriteLiteral("\r\n<script>\r\n\r\n    let wrong2fa = 0;\r\n    var token = \"\";\r\n    let redirecturl = \'");
            EndContext();
            BeginContext(5366, 5, false);
#line 101 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml"
                  Write(Model);

#line default
#line hidden
            EndContext();
            BeginContext(5371, 6706, true);
            WriteLiteral(@"';
    ...
    Login = {
        ...
        open2fa: function () {
            M.Modal");
            WriteLiteral(@".getInstance($('#tfa')).open();
            $('#2facode').focus();
        },
            ...
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                ...
                $.post('/Register/Validate2FA' , { token: token, code: $('#2facode').val() }, function (response) {
                    if (response.status == 'success') {
                        ...
                        wrong2fa++;
                        if (wrong2fa > 5) {
                            M.toast({ html: 'Te veel pogingen. Probeer het later opnieuw',");
            WriteLiteral(@" classes: 'orange ' });
                            Login.cancel2fa();
                        }
                    }
                },'json').fail(function () {
            ...
            if ($('#tfarest').val() == '')
                ...
                $.get('/Register/Restore2FA/' + token + '/' + encodeURIComponent($('#tfarest').val()), function (r) {
                    if (r.status == 'success') {
                        ...
                        $('#secretdiv').show();
                        M.toast({ html: 'Code ");
            WriteLiteral(@"successvol hersteld', classes: 'green' });
                    } else {
