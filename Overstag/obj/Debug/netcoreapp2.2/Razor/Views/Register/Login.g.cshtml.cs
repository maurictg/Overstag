#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ef40cc5f0b08542a452284ac6351a568350980ac"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ef40cc5f0b08542a452284ac6351a568350980ac", @"/Views/Register/Login.cshtml")]
...
#line default
#line hidden
            BeginContext(70, 3638, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ef40cc5f0b08542a452284ac6351a568350980ac2820", async() => {
                BeginContext(76, 3625, true);
                WriteLiteral(@"
    <div class=""row"">
...
");
        ...
        sendmail: function () {
            ...
            $.post(""/Register/postMailreset"", { Email: $('#tbrmail').val() }, function (response) {
                if (response.status == 'success') {
                    $('#tbrmail').val('')
                    M.toast({ html: 'Mail verzonden. Check je email a.u.b.', classes: 'green rounded' });
                }
                else {
                    //status = error
        ...
        login: function () {
            var isValid = true;
  ");
            WriteLiteral(@"          $('.checki').each(function () {
                if ($.trim($(this).val()) == '') {
                    isValid = false;
                }
            });
        ...
        validate2fa: function () {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').va");
            WriteLiteral(@"l())) {
                ...
                $.getJSON('/Register/Validate2FA/'+token+'/'+ $('#2facode').val(), function (response) {
                    if (response.status == 'success') {
                        ...
                        wrong2fa++;
                        if (wrong2fa > 5) {
                            M.toast({ html: 'Te veel pogingen. Probeer het later opnieuw', classes: 'orange rounded' });
                            Login.cancel2fa();
                        }
                    }
                });
      ...
      ");
            WriteLiteral(@"  cancel2fa: function () {
            $('#Username').val('');
            $('#Password').val('');
            $('#2facode').val('');
            M.Modal.getInstance($('#tfa')).close();
