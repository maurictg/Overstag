#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\User\Settings.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "34423c75e7c58265a01b2a32a73c7109b363ef44"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"34423c75e7c58265a01b2a32a73c7109b363ef44", @"/Views/User/Settings.cshtml")]
...
#line hidden
            ...
            <li>
                ...
                <div class=""collapsible-body"">
                    ...
                    <br />
                    <a class=""btn waves-effect btn-small blue"" id=""btngetqr"" onclick=""User.getQR()"">Code ophalen</a>
                    <div id=""qr"">
                        <h6>Scan deze code m");
            WriteLiteral(@"et uw 2FA app (zoals Authy)</h6>
            ...
            <li>
                ...
                <div class=""collapsible-body col s12 m6 center-align"">
                    ...
                    <a class=");
            WriteLiteral(@"""waves-effect waves-light btn green center"" onclick=""M.Collapsible.getInstance($('.collapsible')).close(3);"">Annuleren</a>
        ...
        <div id=""delaccount"" class=""modal"">
            <div class=""modal-content"">
                ...
                <p>
                    ...
                    - 2. U kunt op deze website <b>NIET meer inloggen</b><br />
                    - 3. U kunt uzelf <b>NIET meer inschrijven</b> voor een avond<br />
                    - Uiteraard kunt u opnieuw uzelf registreren als u er spijt van");
            WriteLiteral(@" krijgt
                </p><br />
            </div>
    ...
    <script>
            var User = {
                init: function () {
                    ...
                    $('#cb2fa').attr('checked', ('");
            EndContext();
            BeginContext(9813, 38, false);
#line 164 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\User\Settings.cshtml"
                                              Write(!string.IsNullOrEmpty(Model.TwoFactor));

#line default
#line hidden
            EndContext();
            BeginContext(9852, 4491, true);
            WriteLiteral(@"' == 'True'));
         ...
         ");
            ...
            EndContext();
            BeginContext(14344, 33, false);
#line 255 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\User\Settings.cshtml"
                                                               Write(Uri.EscapeDataString(Model.Token));

#line default
#line hidden
            EndContext();
            BeginContext(14377, 1391, true);
            ...
            EndContext();
            BeginContext(15769, 14, false);
#line 279 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\User\Settings.cshtml"
                                                                                                               Write(Model.Username);

#line default
#line hidden
            EndContext();
            BeginContext(15783, 833, true);
                ...
                getQR: function () {
                    $.getJSON('/User/Get2FA', function (response) {
                        if (response.status == 'success') {
                           $('#qrimg').attr('src', '/Photo/GetQR/'+encodeURIComponent('otpauth://totp/Overstag:");
            EndContext();
            BeginContext(16617, 14, false);
#line 294 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\User\Settings.cshtml"
                                                                                                          Write(Model.Username);

#line default
#line hidden
            EndContext();
            BeginContext(16631, 595, true);
            WriteLiteral(@"?secret=' + response.secret + '&issuer=Overstag'));
                           $('#qrcode').text(response.secret);
                            $('#qr').show();
                            $('#btngetqr').hide();
