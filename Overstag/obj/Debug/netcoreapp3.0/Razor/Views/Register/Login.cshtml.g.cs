#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c04cbec9bc648b3f1674671687e73436408e5d6a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c04cbec9bc648b3f1674671687e73436408e5d6a", @"/Views/Register/Login.cshtml")]
...
#nullable disable
            WriteLiteral("    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c04cbec9bc648b3f1674671687e73436408e5d6a3010", async() => {
                WriteLiteral(@"
        <div class=""row"">
    ...
    Login = {
        ...
        sendmail: function () {
            ...
            $.post(""/Register/postMailreset"", { Email: $('#tbrmail').val() }, function (response) {
                if (response.status == 'success') {
                    $('#tbrmail').val('')
                    M.toast({ html: 'Mail verzonden. Check je email a.u.b. <br><b>Controleer ook je s");
            WriteLiteral(@"pam map</b>', classes: 'green ' });
                }
                else {
                    //status = error
        ...
        post: function () {
            ...
            $.post(""/Register/postLogin"", { Username: $('#Username').val(), Password: $('#Password').val() }, function (response) {
                if (response.status == 'success') {
                    ...
                    if (response.type == 2)
          ");
            WriteLiteral(@"              localStorage.setItem('redirect', '/Mentor');
        ...
        validate2fa: function() {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                ...
                var now = new Date();
                var timestring = now.getDat");
            WriteLiteral(@"e().toString().padStart(2, '0')+'-'+(now.getMonth() + 1).toString().padStart(2, '0')+'-'+now.getFullYear()+' '+now.getHours().toString().padStart(2, '0')+':'+now.getMinutes().toString().padStart(2, '0')+':'+now.getSeconds().toString().padStart(2, '0');
