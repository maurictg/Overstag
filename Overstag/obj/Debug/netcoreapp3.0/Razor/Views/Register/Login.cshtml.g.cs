#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e0801a3cbe8508d6ca12d26dd5031c8f7168677b"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e0801a3cbe8508d6ca12d26dd5031c8f7168677b", @"/Views/Register/Login.cshtml")]
...
#nullable disable
            WriteLiteral("    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e0801a3cbe8508d6ca12d26dd5031c8f7168677b3010", async() => {
                WriteLiteral(@"
        <div class=""row"">
...
#nullable disable
    ...
    Login = {
        ...
        sendmail: function () {
            ...
            $.post(""/Register/postMailreset"", { Email: $('#tbrmail').val() }, function (response) {
                if (response.status == 'success') {
                    $('#tbrmail').val('')
                    M.toast({ html: 'Mai");
            WriteLiteral(@"l verzonden. Check je email a.u.b. <br><b>Controleer ook je spam map</b>', classes: 'green ' });
                }
                else {
                    //status = error
        ...
        toggle: function (enable) {
            if (!enable) {
                $('#btn");
            WriteLiteral(@"login').addClass('disabled');
       ...
       ");
        ...
        validate2fa: function() {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                ...
                var now = new Date();
                var tim");
            WriteLiteral(@"estring = now.getDate().toString().padStart(2, '0')+'-'+(now.getMonth() + 1).toString().padStart(2, '0')+'-'+now.getFullYear()+' '+now.getHours().toString().padStart(2, '0')+':'+now.getMinutes().toString().padStart(2, '0')+':'+now.getSeconds().toString().padStart(2, '0');
