#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e479ab0be3640b3b593834b35bc150fdeb18c47f"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e479ab0be3640b3b593834b35bc150fdeb18c47f", @"/Views/Register/Login.cshtml")]
...
#nullable disable
            WriteLiteral("    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e479ab0be3640b3b593834b35bc150fdeb18c47f3010", async() => {
                WriteLiteral(@"
        <div class=""row"">
    ...
    ");
            ...
            WriteLiteral("\r\n<script>\r\n\r\n    let wrong2fa = 0;\r\n    var token = \"\";\r\n    let redirecturl = \'");
#nullable restore
#line 96 "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml"
                  Write(Model);
...
#nullable disable
    ...
    Login = {
        init: function () {
            ...
            if(OverstagJS.General.restoreMe())
                Login.toggle(true);
        },
   ...
   ");
        ...
        sendmail: function () {
            ...
            $.post(""/Register/postMailreset"", { Email: $('#tbrmail').val() }, function (response) {
                if (response.status == 'success') {
                    $('#tbrmail').val('')
                    M.toast({ html: 'Mail verzonden. Check je email a.u.b. <b");
            WriteLiteral(@"r><b>Controleer ook je spam map</b>', classes: 'green ' });
                }
                else {
                    //status = error
      ...
      ");
            WriteLiteral(@"          $('#Username').attr('disabled',true);
   ...
   ");
            WriteLiteral(@"     redirect: function () {
        ...
        validate2fa: function() {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                ...
                var now = new Date();
                var");
            WriteLiteral(@" timestring = now.getDate().toString().padStart(2, '0')+'-'+(now.getMonth() + 1).toString().padStart(2, '0')+'-'+now.getFullYear()+' '+now.getHours().toString().padStart(2, '0')+':'+now.getMinutes().toString().padStart(2, '0')+':'+now.getSeconds().toString().padStart(2, '0');
        ...
        restore2fa: function () {
            if ($('#tfarest').val() == '')
                ...
                $.get('/Register/Restore2FA/' + token + '/' + encodeURIComponent($('#tfarest').val()), function (r) {
                    i");
            WriteLiteral(@"f (r.status == 'success') {
