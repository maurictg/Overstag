#pragma checksum "C:\Users\mauri\Documents\GitHub\Overstag\Overstag\Views\Mentor\Accountancy\Invoices.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bbaccbb85449b1998495fa83dfb89de2911b29f1"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bbaccbb85449b1998495fa83dfb89de2911b29f1", @"/Views/Mentor/Accountancy/Invoices.cshtml")]
...
#nullable disable
            ...
            BeginWriteAttribute("href", " href=\"", 1065, "\"", 1124, 2);
            WriteAttributeValue("", 1072, "/Pay/Invoice/", 1072, 13, true);
#nullable restore
#line 30 "C:\Users\mauri\Documents\GitHub\Overstag\Overstag\Views\Mentor\Accountancy\Invoices.cshtml"
WriteAttributeValue("", 1085, Uri.UnescapeDataString(item.InvoiceID), 1085, 39, false);
    ...
    var Invoice = {
        ...
        generate: function () {
            $.post('/Accountancy/autoInvoice', {amount: $('#amount').val()}, function (r) {
                if (r.status == 'success') {
                    ...
                    $('#info').show();
                  ");
            WriteLiteral(@"  $('#uc').text(r.usercount);
        ...
        preGenerate: function () {
            ...
            $.getJSON('/Accountancy/processPUE', function (r) {
                if (r.succeed >= 0) {
                    M.toast({ html: 'Automatisch verwerken families voltooid:<br> ' + r.co");
            WriteLiteral(@"unt + ' inschrijvingen verwerkt', classes: 'blue' });
