#pragma checksum "C:\Users\mauri\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1d8ddee6167f7e3f48ac3e655260c1711707995a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1d8ddee6167f7e3f48ac3e655260c1711707995a", @"/Views/Register/Login.cshtml")]
...
#line hidden
#nullable disable
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1d8ddee6167f7e3f48ac3e655260c1711707995a3755", async() => {
                WriteLiteral(@"
    <div class=""row"">
        <div class=""row""></div>
        ...
        <div class=""col s12 m8 offset-m2 l6 offset-l3"">
   ");
                WriteLiteral(@"         <div class=""card rounded"" id=""2facard"" style=""display: none"">
                <div class=""card-content"">
    ...
    <div id=""memailreset"" class=""modal"">
        ...
        <div class=""modal-footer"">
            ...
            <a href=""#!"" id=""sendmai");
                WriteLiteral(@"lreset"" class=""waves-effect waves-green btn-flat"">Verzenden</a>
        </div>
    </div>
...
#nullable restore
#line 103 "C:\Users\mauri\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml"
                                            Write(Model);

#line default
#line hidden
#nullable disable
            WriteLiteral(@""",errorcnt=0;Login={init:function(){$(""#_progbar"").show(),$(""#_reg, #_mreg"").addClass(""active""),$(""#progbar2, #mailhelper"").hide(),Login.mapEvents(),OverstagJS.General.restoreMe(Login.toggleWith,!0,Login.redirect)},mapEvents:function(){$(""#Password"").keydown(function(e){13==e.which&&Login.login()}),$(""#Username"").keydown(function(e){13==e.which&&$(""#Password"").focus()}),$(""#lUsername"").click(function(){$(""#Username"").focus()}),$(""#lPassword"").click(function(){$(""#Password"").focus()}),$(""#btnlogin"").click(function(){Login.login()}),$(""#tbrmail"").on(""keyup"",function(){$(""#mailhelper"").hide()}),$(""#sendmailreset"").click(function(){""""!=$(""#tbrmail"").val()?($(""#mailhelper"").hide(),Login.sendmail()):$(""#mailhelper"").show()}),$(""#2facode"").on(""paste"",function(e){var t=e.originalEvent.clipboardData.getData(""text"");(null==t||null==t||t.length<1)&&(t=$(""#2facode"").val()),t.length>=6&&Login.validate2fa()}),$(""#2facode"").on(""keyup"",function(){$(""#2facode"").val().length>=6&&Login.validate2fa()})},sendmail:function(){$(""#p");
            WriteLiteral(@"rogbar2"").show(),$.post(""/Register/postMailreset"",{Email:$(""#tbrmail"").val()},function(e){""success""==e.status?($(""#tbrmail"").val(""""),M.toast({html:""Mail verzonden. Check je email a.u.b. <br><b>Controleer ook je spam map</b>"",classes:""green ""})):(M.toast({html:e.error,classes:""red ""}),$("".checki"").val(""""))},""json"").done(function(){$(""#progbar2"").hide(),M.Modal.getInstance($(""#memailreset"")).close()})},login:function(){var e=!0;$("".checki"").each(function(){""""==$.trim($(this).val())&&(e=!1)}),e?Login.post():M.toast({html:""Vul a.u.b. alle velden in"",classes:""orange""})},toggleWith:function(e){e&&$(""#logincard"").fadeIn(""slow""),Login.toggle(e)},toggle:function(e){e?($(""#_progbar"").hide(),$(""#lblmoment"").hide(),$(""#btnlogin"").removeClass(""disabled""),$(""#Username"").removeAttr(""disabled""),$(""#Password"").removeAttr(""disabled""),$(""#Username"").focus()):($(""#btnlogin"").addClass(""disabled""),$(""#Username"").attr(""disabled"",!0),$(""#Password"").attr(""disabled"",!0),$(""#_progbar"").show())},post:function(){Login.toggle(!1),$.post(""");
            WriteLiteral(@"/Register/postLogin"",{Username:$(""#Username"").val(),Password:$(""#Password"").val()},function(e){""success""==e.status?(3==e.type&&localStorage.setItem(""redirect"",""/Admin""),2==e.type&&localStorage.setItem(""redirect"",""/Mentor""),""yes""==e.twofactor?(Login.open2fa(),$(""#2facode"").focus(),token=e.token):(Login.redirect(),localStorage.setItem(""remember"",e.remember))):(M.toast({html:e.error,classes:""red ""}),$("".checki"").val(""""))},""json"").done(function(){Login.toggle(!0),$(""#Username"").focus()}).fail(function(){$(""#_progbar"").hide(),M.toast({html:""Inloggen mislukt door interne fout"",classes:""red""})})},redirect:function(){localStorage.setItem(""login"",!0),""""==redirecturl?localStorage.getItem(""redirect"")?($(location).attr(""href"",localStorage.getItem(""redirect"")),localStorage.removeItem(""redirect"")):$(location).attr(""href"",""/User""):$(location).attr(""href"",redirecturl)},open2fa:function(){$(""#logincard"").hide(),$(""#2facard"").fadeIn(""slow""),$(""#2facode"").focus()},validate2fa:function(){if(6!=$(""#2facode"").val().length||isNaN($");
            WriteLiteral(@"(""#2facode"").val()))M.toast({html:""Type aub een geldige code in"",classes:""orange""}),$(""#2facode"").val("""");else{var e=new Date,t=e.getDate().toString().padStart(2,""0"")+""-""+(e.getMonth()+1).toString().padStart(2,""0"")+""-""+e.getFullYear()+"" ""+e.getHours().toString().padStart(2,""0"")+"":""+e.getMinutes().toString().padStart(2,""0"")+"":""+e.getSeconds().toString().padStart(2,""0"");$.post(""/Register/Validate2FA"",{token:token,code:$(""#2facode"").val(),datetime:t},function(e){""success""==e.status?(localStorage.setItem(""remember"",e.remember),Login.cancel2fa(),Login.redirect()):""timeout""==e.status?M.toast({html:""Uw klok staat niet goed."",classes:""orange""}):(M.toast({html:""Validatie mislukt."",classes:""red""}),$(""#2facode"").val(""""),++wrong2fa>5&&(M.toast({html:""Te veel pogingen. Probeer het later opnieuw"",classes:""orange""}),Login.cancel2fa()))},""json"").fail(function(){console.log(""Er gaat iets fout""),++errorcnt>3&&M.toast({html:""Er is iets fout gegaan"",classes:""red""})})}},cancel2fa:function(){$(""#Username"").val(""""),$(""#Password"").v");
            WriteLiteral(@"al(""""),$(""#2facode"").val(""""),$(""#2facard"").hide(),$(""#logincard"").fadeIn(""slow""),$(""#Username"").focus()},restore2fa:function(){""""==$(""#tfarest"").val()?M.toast({html:""Vul a.u.b. alle velden in!"",classes:""orange""}):$.get(""/Register/Restore2FA/""+token+""/""+encodeURIComponent($(""#tfarest"").val()),function(e){""success""==e.status?(M.Modal.getInstance($(""#tfarestore"")).close(),Login.cancel2fa(),M.toast({html:""Code is juist. Log a.u.b. opnieuw in"",classes:""green""})):M.toast({html:""Code onjuist"",classes:""red""}),$(""#tfarest"").val("""")},""json"").fail(function(){M.toast({html:""Er is iets fout gegaan"",classes:""red""})})}},Login.init(),$(document).ready(function(){$(""input#2facode"").characterCounter()});
</script>
