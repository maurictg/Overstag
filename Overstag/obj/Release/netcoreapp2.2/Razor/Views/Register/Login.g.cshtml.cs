#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9f8289f6746415fa606a3a99cb5150a5a895b313"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9f8289f6746415fa606a3a99cb5150a5a895b313", @"/Views/Register/Login.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "9f8289f6746415fa606a3a99cb5150a5a895b3132820", async() => {
...
<script>
    ...
    Login = {
        ...
        mapEvents: function () {
            ...
            $('#2fa");
            WriteLiteral(@"code').on('keyup', function () {
        ...
        validate2fa: function () {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                M.toast({ html: 'Type aub een geldige code in', classes: 'orange roun");
            WriteLiteral(@"ded' });
                $('#2facode').val('');
            }
            else {
                $.getJSON('/Register/Validate2FA/' + $('#2facode').val(), function (response) {
                    if (response.status == 'success') {
                        Login.redirect();
