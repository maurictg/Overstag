#pragma checksum "C:\Users\mauri\Desktop\Projects\ASP\maurictsite\Overstag\Overstag\Views\User\Settings.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4bbd2b8d7f302080cb447c920a020fd2ef1acef3"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4bbd2b8d7f302080cb447c920a020fd2ef1acef3", @"/Views/User/Settings.cshtml")]
    public class Views_User_Settings : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Overstag.Models.Account>
    {
        ...
        {
#line 2 "C:\Users\mauri\Desktop\Projects\ASP\maurictsite\Overstag\Overstag\Views\User\Settings.cshtml"
...
#line 24 "C:\Users\mauri\Desktop\Projects\ASP\maurictsite\Overstag\Overstag\Views\User\Settings.cshtml"
...
#line 25 "C:\Users\mauri\Desktop\Projects\ASP\maurictsite\Overstag\Overstag\Views\User\Settings.cshtml"
...
#line 26 "C:\Users\mauri\Desktop\Projects\ASP\maurictsite\Overstag\Overstag\Views\User\Settings.cshtml"
WriteAttributeValue("", 1313, Model.Email, 1313, 12, false);

#line default
#line hidden
            EndWriteAttribute();
            BeginContext(1326, 9519, true);
            WriteLiteral(@" /></td>
                            </tr>
                        </tbody>
                    </table>
            ...
            WriteLiteral(@" </div>
                    ...
                    <br /><br />
                    <a class=""waves-effect waves-light btn orange center"" onclick=""M.Collapsible.getInstance($('.collapsible')).close(1); $('.checki').va");
            WriteLiteral(@"l('');"">Annuleren</a>
            ...
            <li>
                ...
                <div class=""collapsible-body col s12 m6 center-align"">
                    ...
                    <a class=""waves-effect waves-light btn green center"" onclick=""M.Collapsible.getInstance($(");
            WriteLiteral(@"'.collapsible')).close(2);"">Annuleren</a>
   ...
   ");
            WriteLiteral(@"                 //Detect & check if passwords matches
                ...
                savechanges: function () {
                     $.post(""/User/postInfoChange"", { Firstname: $('#firstname').val(), Lastname: $('#lastname').val(), Email: $('#email').val() }, function (response) {
                        if (response.status == 'success') {
                            M.toast({ html: 'Wijziging");
            WriteLiteral(@"en opgeslagen', classes: 'green' });
                            $('.checki').val('');
            ...
            WriteLiteral(@"                   //status = error
                ...
                delaccount: function () {
                    ...
                    if (confirm('Account verwijderen? Zeker weten?')) {
                        $.post(""/User/postDeleteAccount"", { Token: Overstag.token, Password: pass }, function (response) {
                            if (response.status == 'success') {
              ...
              ");
            WriteLiteral(@"                  M.toast({ html: response.error, classes: 'red' });
                            }
                        }, 'json');
