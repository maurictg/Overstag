#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8f4ca4fd13ecaff9c75968f26b9746c73c18663a"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8f4ca4fd13ecaff9c75968f26b9746c73c18663a", @"/Views/Register/Login.cshtml")]
...
#line hidden
            ...
            WriteLiteral("    ");
            EndContext();
            BeginContext(299, 4892, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e1bc27571644077aebdc501d632bdec", async() => {
                BeginContext(305, 4879, true);
                WriteLiteral(@"
        <div class=""row"">
        ...
        <div id=""memailreset"" class=""modal"">
            <div class=""modal-content"">
                ...
                <div class=""input-field"">
    ");
                WriteLiteral(@"                <i class=""material-icons prefix"">email</i>
    ...
    ");
            ...
            EndContext();
            BeginContext(5191, 81, true);
            WriteLiteral("\r\n<script>\r\n\r\n    let wrong2fa = 0;\r\n    var token = \"\";\r\n    let redirecturl = \'");
            EndContext();
            BeginContext(5273, 5, false);
  ...
  ");
        ...
        redirect: function () {
            ...
            if (localStorage.getItem(""redirect"")) {
                $(location).attr('href', ");
            WriteLiteral(@"localStorage.getItem(""redirect""));
        ...
        validate2fa: function() {
            if ($('#2facode').val().length != 6 || isNaN($('#2facode').val())) {
                ...
                $.post('/Register/Validate2FA', { token: token, code:");
            WriteLiteral(@" $('#2facode').val(), datetime: timestring }, function (response) {
                    if (response.status == 'success') {
                        Login.redirect();
                    ...
                    M.toast({ html: 'Er is iets fout gegaan', class");
            WriteLiteral(@"es: 'red' });
                });
            }
        },
        ...
        restore2fa: function () {
            if ($('#tfarest').val() == '')
                ...
                $.get('/Register/Restore2FA/' + token + '/' + encodeURIComponent($('#tfarest').val()), function (r) {
                    ...
                    M.to");
            WriteLiteral(@"ast({ html: 'Er is iets fout gegaan', classes: 'red' });
                });
            }
        }
    }
