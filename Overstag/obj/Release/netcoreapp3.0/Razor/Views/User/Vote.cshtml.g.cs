#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\User\Vote.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "23636f6d1a091c600189197fcb780a0f277cd863"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"23636f6d1a091c600189197fcb780a0f277cd863", @"/Views/User/Vote.cshtml")]
...
<div class=""fixed-action-btn"">
    <a class=""btn-floating btn-large blue-dark waves-effect"" href=""/User/Events"">
        <i class=""large materia");
            WriteLiteral(@"l-icons"">arrow_back</i>
    </a>
</div>
    ...
    var Vote = {
        ...
        addIdea: function () {
            if ($('#tbtitle').val() == '' || $('#tbdesc').val() == '') {
                ...
                $.post('/User/Vote/postIdea', { T");
            WriteLiteral(@"itle: $('#tbtitle').val(), Description: $('#tbdesc').val() }, function (r) {
                    if (r.status == 'success') {
                        Vote.load();
                        $('#tbtitle').val('');
                        $('#tbdesc').val('');
