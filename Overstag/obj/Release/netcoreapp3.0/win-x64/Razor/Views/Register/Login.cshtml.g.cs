#pragma checksum "C:\Users\maurict\Documents\GitHub\Overstag\Overstag\Views\Register\Login.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "fbcdf1abe09be5709e38f36111bbd0121b01cc69"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"fbcdf1abe09be5709e38f36111bbd0121b01cc69", @"/Views/Register/Login.cshtml")]
...
#nullable disable
            WriteLiteral("    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fbcdf1abe09be5709e38f36111bbd0121b01cc693010", async() => {
                WriteLiteral(@"
        <div class=""row"">
...
#nullable disable
    ...
    Login = {
        init: function () {
            ...
            Login.mapEvents();
            OverstagJS.General.restoreMe(Login.toggle, true);
        },
        ...
        sendmail: function () {
            ...
            $.post(""/Register/postMailreset"", { Email: $('#tbrmail').val() }, function (response) {
                if (response.status == 'success') {
                    $('#tbrmail').val('')
                    M.toast({ html: 'Mail verzonden. Check je email a.u.b. <br");
            WriteLiteral(@"><b>Controleer ook je spam map</b>', classes: 'green ' });
                }
                else {
                    //status = error
