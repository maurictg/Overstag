...
namespace Overstag.Services
{
    public class Pdf
    {
        ...
        {
            const string overstagAdres = "Stichting Overstag<br/>T.a.v. het secretariaat<br/><br/>Kapucijnenweg 28<br/>4411 NC RILLAND<br/>";
            ...
            c.Append($"<h4 class=\"o-blue-text\">Informatie</h4><div class=\"col s6\"><h4 class=\"o-orange-text\">Afzender</h4><h6>{overstagAdres}</h6></div>");
            ...
            c.Append($"<h6><b>Datum: </b> {i.Timestamp.ToString("dd-MM-yyyy HH:mm")}<br/><b>Betreft: </b> Facturering activiteiten <br/><b>Factuurnummer: </b> {i.GetInvoiceNumber()} <br/><b>Online factuur: </b><a href=\"{i.GetInvoiceURL(context)}\">{i.GetInvoiceURL(context)}</a><br/></h6>");
